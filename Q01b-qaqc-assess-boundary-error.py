...
python 09c-qaqc-assess-boundary-error.py --input working-data/03-rough-reef-mask_poly/AU_Rough-reef-shallow-mask-with-GBR.shp --gtp in-data/AU_Shallow-mask-boundary_qaqc/AU_Shallow-mask_gtp_B1.shp --regions in-data/AU_NESP-MaC-3-17_Study-boundary/Reef-mapping-study-boundary.shp

Assess the semi-automated mapping:
python 09c-qaqc-assess-boundary-error.py --input out-data/V1/AU_NESP-MaC-3-17_AIMS_Shallow-mask_Medium-Low_V1.shp --gtp in-data/AU_Shallow-mask-boundary_qaqc/AU_Shallow-mask_gtp_B1.shp --regions in-data/AU_NESP-MaC-3-17_Study-boundary/Reef-mapping-study-boundary.shp
