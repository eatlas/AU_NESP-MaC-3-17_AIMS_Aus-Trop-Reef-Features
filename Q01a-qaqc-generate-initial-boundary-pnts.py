"""
Script: 09b-qaqc-generate-initial-boundary-pnts.py
...
Example:
    python 09b-qaqc-generate-initial-boundary-pnts.py --input working-data/03-rough-reef-mask_poly/AU_Rough-reef-shallow-mask-with-GBR.shp --output in-data/AU_Shallow-mask-boundary_qaqc/AU_Shallow-mask_gtp_B1.shp --num_points 250
"""
